...
contract LastMan is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    LastManDividendTracker public dividendTracker;
    ...
    constructor() ERC20("LastMan", "LASTMAN") {
        marketingWallet = payable(0x3f39B8d07f4568bf2A653494a3584069d0f68227);
        ...
        dividendTracker = new LastManDividendTracker(payable(this), router, 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c, //BTCB
                                                      0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE, //XRP
                                                      "LastManTRACKER", "LMANTRACKER");
    ...
    function setDividendTracker(address NewAddress) public onlyOwner {
        dividendTracker = LastManDividendTracker(payable(NewAddress));
    }
...
contract LastManDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    LastMan public LastManContract;
    ...
    constructor(address payable mainContract, address router, address token, address token2, string memory _name,
        ...
        LastManContract = LastMan(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(false, "withdrawDividend disabled. Use the 'claim' function on the main LastMan contract.");
    }
    ...
    function _reinvestDividendOfUser(address account) private returns (uint256) {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(LastManContract);

            uint256 prevBalance = LastManContract.balanceOf(address(this));
            ...
            {
                uint256 received = LastManContract.balanceOf(address(this)).sub(prevBalance);
                if (received > 0) {
                    success = true;
                    LastManContract.transfer(account, received);
                }
                else {
                    success = false;
                }
